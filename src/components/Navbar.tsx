...
const Navbar = () => {
  ...
  return (
    ...
    >
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="md:hidden flex items-center">
            ...
            <button
              ...
              className="ml-2 p-2 rounded-md hover:bg-secondary transition-colors duration-200"
            >
      ...
      <div
        className={cn(
          "fixed inset-0 z-40 bg-background bg-opacity-95 backdrop-blur-lg md:hidden transition-all duration-300 ease-in-out",
          ...
          <div className="flex flex-col space-y-6">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="text-2xl font-poppins font-medium hover:text-purple transition-colors duration-300"
